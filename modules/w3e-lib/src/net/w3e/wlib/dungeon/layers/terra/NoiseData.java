...
@DefaultJsonCodec(NoiseData.NoiseDataJsonAdapter.class)
public class NoiseData implements Cloneable {
	...
	public enum Mode {
		...
		SKDS() {
			...
			public Object buildData(JsonObject data) {
				return JsonUtils.parseJson(data, NoiseSKDSBuilder.class);
			}
			@Override
	...
	@AllArgsConstructor
	@NoArgsConstructor
	public static class NoiseSKDSBuilder implements JsonDeserializeBuilder<NoiseSKDSBuilder> {
	...
	static class NoiseDataJsonAdapter extends JsonReflectiveBuilderCodec<NoiseLayer> {
