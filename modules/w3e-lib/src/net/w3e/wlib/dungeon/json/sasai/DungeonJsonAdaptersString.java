...
import static net.w3e.wlib.dungeon.json.sasai.DungeonJsonAdapters.INSTANCE;
...
public class DungeonJsonAdaptersString {
	...
	public static class EDungeon implements JsonDeserializeBuilder<DungeonGenerator> {
		private long seed = 0;
