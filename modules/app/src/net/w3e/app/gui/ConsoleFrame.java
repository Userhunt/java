...
import net.w3e.wlib.awtutils.components.JConsoleTextArea;
import net.w3e.wlib.awtutils.frame.AppJFrame;
import net.w3e.wlib.awtutils.utils.JVersionedGuiUtils;

@CustomLog
public class ConsoleFrame extends AppJFrame implements JVersionedGuiUtils {
	...
	public ConsoleFrame(String title) {
		...
		this.addCloseEvent(_ -> disableConsole());
	...
	public void disableConsole() {
		int a = this.enabled.accumulateAndGet(0, (prev, _) -> Math.max(0, prev - 1));
