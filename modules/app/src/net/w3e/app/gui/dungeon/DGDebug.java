...
import net.w3e.app.gui.dungeon.layers.TestNoiseLayer;
...
public class DGDebug {
	...
	public static SimpleCollectionBuilder<DungeonLayer, ArrayList<DungeonLayer>> factoryCollectionBuilder() {
	 ...
	 * 
	 */
	public static DGFactory example(DGRegistry registry, long seed, Mode mode) {
		final int size = SIZE;
	...
	public static DGFactory exampleSave(DGFactory generator, boolean debug) {
		DGFactory data;
