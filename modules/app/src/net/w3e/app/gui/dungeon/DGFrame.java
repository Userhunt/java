...
import net.w3e.app.gui.JImageFrame;
import net.w3e.app.gui.ProgressFrame;
import net.w3e.app.gui.dungeon.layers.TestLayers;
import net.w3e.app.gui.dungeon.registry.DGRegistry;
import net.w3e.app.gui.dungeon.registry.DGRegistryFrame;
...
import net.w3e.wlib.awtutils.utils.JVersionedGuiUtils;
...
@CustomLog
public class DGFrame extends AppJFrame implements JVersionedGuiUtils {
	...
	public final void creteDungeon(String name, DungeonGenerator dungeon, DGDebug.Mode mode) {
		this.processId++;
	...
	private class DungeonImagePainter extends JImageFrame implements MouseListener {
		...
		public void mouseClicked(MouseEvent event) {
			...
			if (!data.exists()) {
				...
				JFrameGuiUtils.addCloseEvent(frame, _ -> frame.setEnabled(false));
				...
				AppJFrame.simpleColumn(frame, list);
