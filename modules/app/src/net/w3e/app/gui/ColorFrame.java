...
import net.w3e.wlib.awtutils.components.JNumberTextField;
...
public class ColorFrame extends JFrame implements JFrameGuiUtils {
	...
	private class RGBAPanel extends JPanel {
		...
		private JPanel createLine(int width, boolean i) {
			JPanel panel = new JPanel();
		...
		private void createNumberField(JPanel panel, int width, boolean i, ColorPackFlag flag) {
