...
import net.w3e.app.v1.old.api.window_old.FrameWin;
import net.w3e.app.v1.old.api.window_old.Inputs;
...
public class MainFrame {
	...
	public static final FrameWin FRAME = new FrameWin("Base " + version(version())) {
		@Override
