package net.w3e.app.v1.old.api.window_old;

import net.w3e.app.v1.old.MainFrame;
import net.w3e.app.v1.old.api.StopEvent;
...
public abstract class AbstractFrameWin extends JFrame {
	...
	public static void simpleColumn(Container container, List<? extends Component> list) {
		int w = 0;
		...
		for (Component component : list) {
			JGuiUtils.setSize(component, w, component.getPreferredSize().height);
		}

		Iterator<? extends Component> iterator = list.iterator();
