package net.w3e.app.v1.u.utils.cyberpunk.generators;

import net.w3e.app.v1.u.utils.cyberpunk.CyberpunkGenerator;
import net.w3e.app.v1.u.utils.cyberpunk.Rarity;
import net.w3e.app.v1.u.utils.cyberpunk.ShopPage;

public class ShardsGenerator {
	public ShardsGenerator(CyberpunkGenerator generator) {
