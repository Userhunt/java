...
import net.w3e.app.v1.gui.AppJFrame.AppJFrameFactoryMultiple;
import net.w3e.app.v1.gui.AppJFrame.AppJFrameNamedFactoryImpl;
import net.w3e.app.v1.u.main.MainFrame.Args;
import net.w3e.app.v1.u.utils.cyberpunk.CyberpunkGeneratorGui;
import net.w3e.app.v1.u.utils.manga.MangaGui;
import net.w3e.app.v1.u.utils.poe.PoeGui;
import net.w3e.app.v1.u.utils.tasklist.TaskListGui;
import net.w3e.app.v1.u.utils.tf2.Tf2Gui;
...
public class UtilsFrameFactory implements AppJFrameFactoryMultiple {
	...
	public Collection<Object> values() {
		...
		list.add(new AppJFrameNamedFactoryImpl("TaskList", this::taskList));
	...
	private JFrame taskList(JFrame parent, Args args) {
