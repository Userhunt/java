...
import net.api.assets.Asset;
import net.api.assets.AssetCollector;
import net.api.assets.AssetHolder;
...
public class PngAsset extends Asset<BufferedImage> {
	...
	protected final void loadFile(String key, File file) throws IOException {
		this.add(true, key, ImageUtil.read(new FileInputStream(file)));
	}

	@Override
	public void loadJar(String key, String file) throws IOException {
		this.add(false, key, ImageUtil.read(this.getJarInputStream(file)));
	}
