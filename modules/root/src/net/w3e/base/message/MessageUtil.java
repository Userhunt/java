...
public class MessageUtil {
	...
	public static final MessageError REQUIRED = new MessageError("Required \"%s\"");
	...
	public static void info(BMessageLogger logger, String string, Object... object) {
		logger.info(string);
	}

	public static void warn(BMessageLogger logger, String string, Object... object) {
		logger.warn(string);
	}

	public static void debug(BMessageLogger logger, String string, Object... object) {
		logger.debug(string);
	}

	public static void error(BMessageLogger logger, String msg, Object... object) {
		logger.error(msg);
	}
}
