...
public class ReflectionUtils {
	...
	public static final boolean instaceOf(Object object, Class<?> type) {
		return (object instanceof Class<?> class1) ? instaceOf(class1, type) : (object == null ? false : instaceOf(object.getClass(), type));
	}
