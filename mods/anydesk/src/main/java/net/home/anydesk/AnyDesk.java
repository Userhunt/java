...
import net.w3e.base.api.window.WaitTimer;
	...
	protected void init(FrameWin fw, List<String> args) {
		fw.tick(5000, new WaitTimer.TimerExt() {
			...
			protected void runExt() {
				System.out.println(ImageUtil.difImagesNoAlpha(IMAGE, JNAWindow.capture(new Rectangle(0, 0, 1680 - 490, 1080 - 329))));
				if (ImageUtil.difImagesNoAlpha(IMAGE, JNAWindow.capture(new Rectangle(0, 0, 1680 - 490, 1080 - 329))) <= 1) {
