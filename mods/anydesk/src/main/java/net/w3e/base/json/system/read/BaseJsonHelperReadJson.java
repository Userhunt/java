...
public interface BaseJsonHelperReadJson extends BaseJsonHelper {
	...
	default JsonObject readJsonObject(JsonObject j, String target, JsonObject def, String arg) {
		return this.readJsonObject(j, target, def, arg, true);
	}
	default JsonObject readJsonObject(JsonObject j, String target, JsonObject def, String arg, boolean log) {
		return this.readJsonObject(j, target, def, arg, log, false);
	}
	default JsonObject readJsonObject(JsonObject j, String target, JsonObject def, String arg, boolean log, boolean canBeNull) {
		return BaseJsonHelperReadJson.readJsonObject(logger(), j, target, def, arg, log, canBeNull);
	}
	static JsonObject readJsonObject(Logger logger, JsonObject j, String target, JsonObject def, String arg, boolean log, boolean canBeNull) {
		return BJsonUtil.readJsonObject(logger, j, target, def, arg, log, canBeNull);
	}
